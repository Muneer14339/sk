...
class _TrainingProgramsPageState extends State<TrainingProgramsPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(
          title: 'Training Programs', context: context, showBackButton: false),
      body: SafeArea(
  ...
  Widget _buildErrorState(String error) => Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Colors.transparent,
              AppColors.kError..withValues(alpha: .05),
            ],
          ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    AppColors.kPrimaryTeal..withValues(alpha: .1),
                    Colors.transparent
                  ],
                ),
                shape: BoxShape.circle,
            ...
            const SizedBox(height: 8),
            Text(
              'Preparing your training catalog...',
              style: TextStyle(
                fontSize: 14,
                color: AppColors.kTextSecondary,
              ),
  ...
  Widget _buildGearStatusBanner() => GestureDetector(
        onTap: () {
          _hapticFeedback();
          _openGearSetup();
        },
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 13,
                        color: AppColors.kTextPrimary..withValues(alpha: .8),
                        height: 1.3,
                      ),
                    ),
                  ],
  ...
  Widget _buildQuickStartSection() => Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
          color: AppColors.kSurface, borderRadius: BorderRadius.circular(8)),
  ...
  Widget _buildModernQuickStartButton(
          String title, Color color, BleScanState state) =>
      GestureDetector(
        onTap: () {
          if(state.isConnected && state.needsCalibration){
            _showCalibrationDialog(context, state.connectedDevice!, systemPrograms.first);
          }
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    SteadinessTrainerPage(program: systemPrograms.first),
              ),
            );
          } else {
  ...
  Widget _buildModernRecentProgramItem(
          String icon, String title, String subtitle, Color accentColor) =>
      GestureDetector(
  ...
  Widget _buildModernFilterTabs() => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
              color: AppColors.kTextSecondary..withValues(alpha: .3)),
        ),
        child: Row(
          children: [
    ...
    return Column(
      children: filteredPrograms
          .map((program) => Padding(
                ...
                child: _buildModernProgramCard(program),
              ))
          .toList(),
    );
  }
  ...
  Widget _buildEmptyProgramsState() => Container(
        ...
        decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Colors.transparent,
                AppColors.kPrimaryTeal..withValues(alpha: .05),
              ],
            ),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
                color: AppColors.kPrimaryTeal..withValues(alpha: .2))),
        child: Column(
          children: [
            Container(
                padding: const EdgeInsets.all(24),
                ...
                child: Icon(Icons.library_books_outlined,
                    color: AppColors.kPrimaryTeal, size: 48)),
            const SizedBox(height: 16),
            ...
            const SizedBox(height: 8),
            Text(
              'Try adjusting your filters or create a custom program',
              style: TextStyle(
                fontSize: 14,
                color: AppColors.kTextSecondary,
              ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            AppColors.kPrimaryTeal,
                            AppColors.kPrimaryTeal..withValues(alpha: .7)
                          ],
                        ),
                        borderRadius: BorderRadius.circular(16),
                      ),
          ...
          if (program.badgeColor != null)
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color(int.parse(program.badgeColor ?? '0xFF00CED1')),
                  borderRadius: BorderRadius.circular(12),
                  boxShadow: [],
                ),
                child: Text(
  ...
  Widget _buildModernProgramSpecs(ProgramsModel program) => Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              AppColors.kSurface..withValues(alpha: .5),
              AppColors.kBackground..withValues(alpha: .5),
            ],
          ),
          borderRadius: BorderRadius.circular(12),
          border:
              Border.all(color: AppColors.kPrimaryTeal.withValues(alpha: .08)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Widget _buildModernSpecRow(String label, String value, IconData icon) =>
      Padding(
  ...
  Widget _buildModernProgramActions(ProgramsModel program) =>
      BlocBuilder<BleScanBloc, BleScanState>(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          AppColors.kError,
                          AppColors.kError..withValues(alpha: .8)
                        ],
                      ),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                          color: AppColors.kError..withValues(alpha: .3))),
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              AppColors.kTextPrimary..withValues(alpha: .2),
                              Colors.transparent
                            ],
                          ),
                          shape: BoxShape.circle,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        AppColors.kTextSecondary,
                        AppColors.kTextSecondary..withValues(alpha: .8)
                      ],
                    ),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
  ...
  void _showNoFirearmsDialog() => showDialog(
        context: context,
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.warning_amber,
                          color: AppColors.kTextPrimary, size: 24),
                      SizedBox(width: 12),
                      Expanded(
                        child: Text(
                          'No Firearms Configured',
                          style: TextStyle(
                            color: AppColors.kTextPrimary,
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text(
                        'To create custom training programs, you need to configure at least one firearm setup.',
                        style: TextStyle(
                          fontSize: 15,
                          color: AppColors.kTextPrimary,
                          height: 1.4,
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      AppColors.kSuccess,
                                      AppColors.kSuccess..withValues(alpha: .8)
                                    ],
                                  ),
                                  borderRadius: BorderRadius.circular(12),
                                  boxShadow: [
...
// ✅ ADD: Show error dialog in BlocListener
  void _showBleDeviceDialog(BuildContext context,
      {ProgramsModel? program}) async {
      ...
      builder: (_) => BlocConsumer<BleScanBloc, BleScanState>(
        listener: (ctx, state) {
          if (state.isConnected && state.needsCalibration) {
            ...
            print('✅ Default settings applied: $sensitivity');
            Navigator.of(context).pop(); // Close BLE dialog
            _showCalibrationDialog(context, state.connectedDevice!, program);
          } else if (state.isConnected) {
            context.read<TrainingSessionBloc>().add(
                  SendCommand(
          ...
          // ✅ NEW: Show error dialog like steadiness page
    ...
    showDialog(
      ...
      builder: (_) => DeviceCalibrationDialog(
        onStartCalibration: () async {
          // Enable sensors - this triggers calibration in sensor_processor
          context.read<TrainingSessionBloc>().add(
            EnableSensors(
              device: device,
            ),
          ...
          context.read<BleScanBloc>().add(MarkCalibrationComplete());
...
// ✅ NEW: Error dialog method
  ...
  void _navigateToTrainingPage(BuildContext context, ProgramsModel program) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => SteadinessTrainerPage(program: program)),
    );
  }
}
