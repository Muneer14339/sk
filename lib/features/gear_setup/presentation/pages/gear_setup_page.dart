...
class _GearSetupPageState extends State<GearSetupPage>
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Choose a common configuration to get started quickly',
                style: TextStyle(
                  fontSize: 14,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(details,
                    ...
                    style:
                        const TextStyle(fontSize: 12, color: Color(0xFF6C757D)),
                    textAlign: TextAlign.center),
              ],
            ),
          ),
        ...
        children: List.generate(_tabs.length, (index) {
          ...
          return Expanded(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isActive ? const Color(0xFF2C3E50) : Colors.transparent,
  ...
  // Widget _buildAmmoCard(
  //     String name, String description, String id, GearSetupState state) {
  //   final isSelected = state.gearSetup.ammo == id;

  //   return GestureDetector(
  //     onTap: () => context.read<GearSetupBloc>().add(GearSetupAmmoChanged(id)),
  //     child: Container(
  //       padding: const EdgeInsets.all(16),
  //       margin: const EdgeInsets.only(top: 8),
  //       decoration: BoxDecoration(
