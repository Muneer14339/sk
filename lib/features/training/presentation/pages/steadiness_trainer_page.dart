...
import 'package:pulse_skadi/features/training/presentation/widgets/session_controls.dart';
import 'package:pulse_skadi/features/training/presentation/widgets/target_display.dart';
import 'package:pulse_skadi/features/training/presentation/widgets/calibration_wizard_dialog.dart';
...
class _SteadinessTrainerPageState extends State<SteadinessTrainerPage> {
  ...
  void initState() {
    super.initState();
    context.read<TrainingSessionBloc>().add(ClearLastSession());
                ...
                child: Column(
                  children: [
                    ...
                    SessionControls(
                      ...
                      isPaused: sessionState.isPaused, // NEW: Pass pause state
                      startTraining: _startTraining,
                      stopTraining: () =>
                          _pauseTraining(sessionState), // Renamed callback
                      resetTrace: _resetTrace,
                      finishSession: _finishSession, // NEW: Finish callback
                    ),
                    const SizedBox(height: 16),
  ...
  void _startTraining() {
    ...
    if (sessionState.isPaused) {
      ...
      // Fresh start
      context.read<TrainingSessionBloc>().add(const StartTrainingSession());
    }
  ...
  void _navigateToAnalysisPage(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => const ManticXAnalysisPage()),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // NEW: Second row - missed shots metric
                ...
                ...s.shotLog.take(10).map((shot) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(
                          color: AppColors.kBackground.withOpacity(0.8),
                        ),
                      ),
                    ),
                    child: Row(
