    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          //   context: context,
          //   heading: 'AVT',
          //   value: state.avt.toString(),
          //   onIncrease: () =>
          //       context.read<CounterSensBloc>().add(IncrementAvt()),
          //   onDecrease: () =>
          //       context.read<CounterSensBloc>().add(DecrementAvt()),
          // ),
          // _buildSensitivityRow(
          //   context: context,
          //   heading: 'AVDM',
          //   value: state.avdt.toString(),
          //   onIncrease: () =>
          //       context.read<CounterSensBloc>().add(IncrementAvdt()),
          //   onDecrease: () =>
          //       context.read<CounterSensBloc>().add(DecrementAvdt()),
          // ),
        ],
      ),
    );
  ...
  Widget _buildSensitivityRow({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppColors.kGreenColor.withValues(alpha: 0.2), width: 0.5),
        boxShadow: [
          BoxShadow(
