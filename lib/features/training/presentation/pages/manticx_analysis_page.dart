...
import 'package:pulse_skadi/features/training/data/model/streaming_model.dart'
    as streaming;
import 'package:pulse_skadi/features/training/presentation/widgets/shot_details_content.dart';
...
class _ManticXAnalysisPageState extends State<ManticXAnalysisPage>
              ...
              Padding(
                ...
                child: BlocConsumer<TrainingSessionBloc, TrainingSessionState>(
                  ...
                  builder: (context, trainingState) {
                    ...
                    // NEW: Create combined list of all shots
                    ...
                    if (_selectedShotNumber == -1 && shotTraces.isNotEmpty) {
                      _selectedShotNumber = shotTraces.first.shotNumber;
                      _isMissedShot =
                          missedShots.contains(_selectedShotNumber); // NEW
                    }
                    ...
                    Stack(
                      children: [
                        ...
                        CustomScrollView(
                          slivers: [
                            SliverToBoxAdapter(
                                child: _buildShotSelectionRow(
                                    allShotNumbers,
                                    missedShots,
                                    steadinessShots)), // NEW: Pass steadinessShots // NEW
                            SliverToBoxAdapter(
                                child: _buildTargetDisplay(analysisModel)),
                            SliverToBoxAdapter(
                                child: _buildShotDetailsPanel(analysisModel)),
                            if (savedSession == null)
                              SliverToBoxAdapter(
                                  child: Padding(
                                ...
                                child: PrimaryButton(
                                    title: 'Save Session',
                                    isLoading: trainingState.isSavingSession,
                                    onTap: () => context
                        ...
                        // NEW: Zoom overlay (now has access to analysisModel)
                        if (_zoomEnabled)
                          Positioned.fill(
  ...
  Widget _buildShotSelectionRow(
    ...
    //   children: [
    //     _buildSectionHeader("Shot Performance", "${allShots.length} shots"),
...
// NEW: Add missed shot display
  Widget _buildMissedShotDisplay() => AspectRatio(
        aspectRatio: 1,
        child: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(16),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Shot detected outside target area',
  ...
  // Widget _buildTargetRings() => SizedBox.expand(
  //       child: Stack(
  //         alignment: Alignment.center,
  //         children: [
  //           ...[
  ...
  //             0.83,
  //             1.0,
  //           ].map((size) => _buildModernTargetRing(size)),
  //           Positioned.fill(child: CustomPaint(painter: CrosshairPainter())),
  //         ],
  //       ),
  //     );

  Widget _buildShotDetailsPanel(AnalysisModel? analysisModel) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
          ...
          analysisModel != null
              ? ShotDetailsContent(shotTrace: analysisModel)
              : _buildNoShotSelected(),
        ],
      );

  Widget _buildNoShotSelected() => Container(
        height: 120,
        padding: const EdgeInsets.all(40),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              'Choose a shot above to view comprehensive analysis',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
                color: AppColors.kTextSecondary,
