      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<BleScanBloc, BleScanState>(
            builder: (_, state) {
              return _buildQuickStartButton('🎯', 'Precision Training',
                  state.isConnected ? Color(0xFF7C3AED) : Color(0xFF6B7280),
                  () {
