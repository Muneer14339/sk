      ...
      body: BlocBuilder<BleScanBloc, BleScanState>(
        builder: (context, bleState) {
          return BlocConsumer<TrainingSessionBloc, TrainingSessionState>(
            ...
            final isConnected = bleState.connectedDevice != null;
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              // // Shot Markers (only rebuilds when shotData changes)
                              // BlocSelector<TrainingSessionBloc,
                              //     TrainingSessionState, List<ShotData>>(
                              //   selector: (state) => state.shotData,
                              //   builder: (context, shotData) {
                              //     // print(
                              //     //     'UI: shotData updated, length= [32m${shotData.length} [0m');
                              //     return Stack(children: [
                              //       ...shotData.map((shot) {
                              //         return Positioned(
                              //             left:
                              //                 (shot.normalizedX + 1) / 2 * 100,
                              //             top: (shot.normalizedY + 1) / 2 * 100,
                              //             child: _ShotMarker(
                              ...
                              //   },
                              // ),
                              // Trace (only rebuilds when sensorStream.points changes)
                              Positioned.fill(
                                child: CustomPaint(
                                    painter: TracePainter(sessionState
                                            .sensorStream?.points
                                            .toList() ??
                                        [])),
                              )
                      ...
                      const Row(
                        ...
                        children: [
                          ...
                          _LegendItem(
                              color:
                                  Color(0xffdc3545), // Red for shot detection
                              label: 'Shot break'),
                          SizedBox(width: 15),
                          ...
                          _LegendItem(
                              color: Color(
                                  0xffdc3545), // Red for post-shot/recovery
                              label: 'Recovery'),
                          SizedBox(width: 15),
                          ...
                          _LegendItem(
                              color: Color(
                                  0xffffc107), // Yellow for previous shots
                              label: 'Previous'),
                        ],
                      ),
                      const SizedBox(height: 15),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10),
                              _buildStabilityBar('Stability', 0.75),
                              _buildStabilityBar('Trigger Control', 0.8),
                            ],
                          ),
                        ),
                      ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              const Color(0xff343a40).withValues(alpha: 0.95),
                          borderRadius: BorderRadius.circular(12.0),
                          boxShadow: [
                            BoxShadow(
                                color: Colors.black.withValues(alpha: 0.2),
                      ...
                      //         decoration: BoxDecoration(
                      //           color: sessionState.hapticEnabled
                      ...
                      //             Text(
                      //               'Haptic Feedback: ${sessionState.hapticEnabled ? "ON" : "OFF"}',
                      //               style: TextStyle(
                      //                 fontSize: 14,
                      //                 fontWeight: FontWeight.w500,
                      //                 color: sessionState.hapticEnabled
