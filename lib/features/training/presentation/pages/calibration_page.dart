...
class _CalibrationPageState extends State<CalibrationPage> {
  ...
  void initState() {
    ...
    context.read<TrainingSessionBloc>().add(const ClearLastSession());
  ...
  void _startCalibration() {
    ...
    if (bleState.connectedDevice != null) {
      final calibrationProgram = systemPrograms.first.copyWith(
        programName: 'Calibration Session',
        noOfShots: targetShots,
      );
