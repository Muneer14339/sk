  ...
  Widget _buildTraceStatusIndicator(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            hasTraceData ? Icons.timeline : Icons.info_outline,
            color: hasTraceData
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  if (state.selectedShotId != null)
                    // Naya top-right positioned Zoom Out button
                    Positioned(
                      top: 5,
                      right: 5, // opposite side
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.white.withOpacity(0.9),
                          shape: BoxShape.circle,
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppColors.kPrimaryColor.withValues(alpha: 0.9),
