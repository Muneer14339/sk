...
class TracePainter extends CustomPainter {
  ...
  void _drawPhaseLines(Canvas canvas, Size size, List<TracePoint> phasePoints,
    ...
    for (int i = 0; i < phasePoints.length; i++) {
      ...
      final x = ((point.x + 180) / 360) * size.width;
      final y = ((point.y + 180) / 360) * size.height;
      ...
      if (!pathStarted) {
        ...
        if (i > 0) {
          ...
          final prevX = ((prevPoint.x + 180) / 360) * size.width;
          final prevY = ((prevPoint.y + 180) / 360) * size.height;
